...
df = pd.read_parquet(reglas_dir / 'segmento_vip_premium' / 'Basket.parquet')
df_reglas = pd.read_csv(reglas_dir / 'segmento_vip_premium' / 'reglas.csv', sep=';')
...
plt.scatter(jitter, 
            ...
            s=10, 
            color='#D92E0D')
plt.title('Distribución del ticket promedio en el Segmento VIP Premium')
