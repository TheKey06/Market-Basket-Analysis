...
df = pd.read_parquet(reglas_dir / 'segmento_premium' / 'Basket.parquet')
df_reglas = pd.read_csv(reglas_dir / 'segmento_premium' / 'reglas.csv', sep=';')
...
plt.scatter(jitter, 
            ...
            s=10, 
            color='#D92E0D')
plt.title('Distribución del ticket promedio en el Segmento Premium')

# Use a robust path relative to this file: app/pages/premium.py -> parents[2] = repo root
st.markdown('### Distribución inicial de clientes en el segmento premium')
