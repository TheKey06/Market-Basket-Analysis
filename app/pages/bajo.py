...
df_reglas = pd.read_csv(reglas_dir / 'segmento_bajo' / 'reglas.csv', sep=';')

df_dispersion = df.groupby('cliente').agg({
    'ticket_promedio': 'mean',
    'cl_value':'mean',
    'frecuencia':'mean',
    'linea_favorita':'unique',
    'marca_favorita':'unique',
    'margen_promeido':'first'
    
    
})


## Grafica de violín para la distribución del ticket promedio
